...
if __name__ == '__main__':
    ...
    data_path = base_path.joinpath('Sensitivity_Test_Data', str(obs_date).replace('-', ''))    #path to data
    ...
    save_path = base_path.joinpath('sensitivity_model_output', str(obs_date).replace('-', '') + '_diagnostics', 'Sensitivity', minute_dir)       #path to save outputs in
